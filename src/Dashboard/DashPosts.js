    ...
    <>
      ...
      <Box className="Dash-container">
        ...
        <Box className="Dash-content">
          <DashPagesTitle
            title="
          ادارة المنشورات التثقيفية"
            description="
قم بانشاء وتحرير المحتوى التثقيفي لعملائك بطريقة مهنية وجذابة"
            addButtonLebal=" + 
     إضافة منشور جديد"
          ...
          >
            <Stack
              sx={{ flexBasis: "60%", gap: 2, textAlign: "right !important" }}
              direction="column"
            >
              <Typography
                variant="h4"
              ...
              >
                {" "}
                <EditNoteIcon sx={{ fontSize: "40px", color: "#0D6F73" }} />
                محرر المنشورات{" "}
              </Typography>
              <Divider />
              <Stack
              ...
              <Typography variant="h4" margin="0px 10px">
                العنوان
              </Typography>
              <TextField
            ...
            <Stack direction="column">
              ...
              >
                ...
                <Button variant="contained">عرض الكل</Button>
              </Stack>
              <Stack sx={{ direction: "column", gap: 5 }}>{posts}</Stack>
            </Stack>
          </Stack>
        </Box>
      </Box>
