          ...
          <DialogContent >
              <Grid container spacing={2} sx={{ marginTop: 1 }}>
                ...
                <TextField
                                    ...
                                    label=" اسم الباقة"   
                                    fullWidth
                          variant="outlined" sx={{   '& .MuiOutlinedInput-root.MuiInputBase-root.Mui-focused': {
            width:'100%'
          },'& .MuiOutlinedInput-root':{width:'100%'},'& .Mui-focused fieldset': { "& .MuiInputLabel-root.Mui-focused": { marginTop: '0px' }, '&.MuiOutlinedInput-notchedOutline legend':{ textAlign:'right'} } }}
                            />
                  </Grid>
                       <Grid item size={12} sx={{}}>
                <TextField
            ...
            width:'100%'
                  ...
                  <Grid item size={12} sx={{}}>
                      <Typography variant='h6' sx={{ marginBottom: 1 }}> التصنيف </Typography>
   <Button
